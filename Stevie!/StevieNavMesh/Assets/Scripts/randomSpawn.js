#pragma strict
    ...
    var timeRangeLow : int = 1;
    var timeRangeHigh : int = 3;
    ...
    function Spawn(){
     ...
     var thingToMake : GameObject = Instantiate(enemies[Random.Range(0, enemies.Length)], location.position, location.rotation);
      //thingToMake.AddForce(Vector3(0,0,100));
     
     //halt script for 1 second before returning to the start of the process
     yield WaitForSeconds(Random.Range(timeRangeLow, timeRangeHigh));
